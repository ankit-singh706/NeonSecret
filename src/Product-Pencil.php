...
<html lang="en">
  ...
  <?php require 'partials/_nav.php' ?>
    <div><h2 class="center-heading">Pencil</h2></div>
      ...
      >
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img class="testimonial-img" src="./assets/images/Pencil-3.jpg" alt="" />
          </div>

          <div class="carousel-item">
            <img
              class="testimonial-img"
              src="./assets/images/Pencil-4.jpg"
              alt=""
            />
          </div>
          <div class="carousel-item">
            <img
              class="testimonial-img"
              src="./assets/images/Pencil-5.jpg"
              alt=""
            />
          </div>
        </div>
    ...
    <div class="desc-sec">
      ...
      <p class="para">
        ➤The pencil, a quiet invitation to her artist soul to conjure some daring act of creation. <br/>
    ...
    <div class="specs-sec">
        ...
        <p class="para">
            ➤Lead core (3mm core)<br/>
            ➤Quality wood casing<br/>
            ➤Round in shape<br/>
            ➤Suitable for use on all paper surfaces<br/>
            ➤The length of the pencil is 175mm<br/>
            ➤Eraser present behind the pencil<br/>
        </p>
      </div>
